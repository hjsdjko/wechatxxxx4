...
wx.navigateTo({
url: `/pages/yuangong/update-and-add?id=${id}`
})
},
async detailBtn(e) {
...
this.setData({
addAuth: utils.isAuth("yuangong", "新增") || utils.isAuthFront("yuangong", "新增"),
delAuth: utils.isAuth("yuangong", "删除") || utils.isAuthFront("yuangong", "删除"),
editAuth: utils.isAuth("yuangong", "修改") || utils.isAuthFront("yuangong", "修改"),
})
